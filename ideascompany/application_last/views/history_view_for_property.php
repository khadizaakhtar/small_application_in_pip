        ...
        <div class="row">
                               ...
                               if(!is_array($town)){
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a class="popup-with-zoom-anim khadiza" href="#my-dialog" data-attr="<?php echo  $result2[$key]['0']['requirement_id']; ?>" data-tenant="<?php echo $result2[$key]['0']['tenant_name'];?>" data-agent="<?php echo $result2[$key]['0']['agent_name'];?>"><input href="#my-dialog" data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>" type="checkbox" name="data[requirement_id]" class="reminder" >
                                            <input  type="hidden" name="requirement_id" value="<?php echo $result2[$key]['0']['requirement_id']; ?>"></a>
                                        </td>
                                        <td align="center"><input data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>"  type="checkbox" name="data[requirement_id]" class="interested">
                                            <input  type="hidden" name="requirement_id" value="<?php echo  $result2[$key]['0']['requirement_id']; ?>"></td>
                                        <td align="center"><input data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>"  type="checkbox" name="data[requirement_id]" class="offered_received">
                                            <input  type="hidden" name="requirement_id" value="<?php echo $result2[$key]['0']['requirement_id']; ?>"></td>
                                        <td align="center"><input data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>" type="checkbox" name="data[requirement_id]" class="rejected">
                                            <input  type="hidden" name="requirement_id" value="<?php echo  $result2[$key]['0']['requirement_id']; ?>"></td>
                                        <!--<td><input data-requirementid="<?php echo $v_info['requirement_id']; ?>"  type="checkbox" name="data[requirement_id]" class="comment">
                                            <input  type="hidden" name="requirement_id" value="<?php echo  $result2[$key]['0']['requirement_id']; ?>"></td>-->
                                        <td align="center">
                                            <input data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>" type="checkbox" name="data[requirement_id]" class="no_response">
                                            <input  type="hidden" name="requirement_id" value="<?php echo $result2[$key]['0']['requirement_id']; ?>">
                                        </td>
                                        <td align="center">
                                            <input data-requirementid="<?php echo  $result2[$key]['0']['requirement_id']; ?>" type="checkbox" name="data[requirement_id]" class="accepted">
                                            <input  type="hidden" name="requirement_id" value="<?php echo $result2[$key]['0']['requirement_id']; ?>">
                                        </td>
                                        <td>
            ...
            <div id="my-dialog" class="zoom-anim-dialog  mfp-hide border">
                ...
                <form action="<?php echo BASE_URL; ?>email_remainder_controller/save_remainder" method="post">
                    <div class="padd">
                     <h4> Hi { <p id="tenant"></p> } </h4>
                        <div>We sent you an email about a property we thought <br/>
                            you may be interested in.<br/>Have you had a moment to review it?<br/>
                            Thanks<br/>{ <p id="agent"></p> }
                        </div>
                        <div>
