					   ...
					   <table id="example" class="table deals-table" >
                                               ...
                                               <tbody>
                                                ...
                                                foreach ($result as $v_info) {
                                                    ?>
                                                   <tr>
       <td> <img height="76px" width="106px" src="<?php echo BASE_URL .'uploads/'. $v_info['image'] ?>"></td>                                              
                                                   <td><?php echo $v_info['address_line1'] ?></td> 
                                                   <td><?php echo $v_info['use_class'] ?></td> 
                                                   <td><?php echo $v_info['site_area'] ?></td>
                                                   <td><a href="<?php echo BASE_URL; ?>admin_controller/edit_new_property/<?php echo $v_info['property_id']; ?>">Edit</a> | 
                                                       <a href="<?php echo BASE_URL; ?>admin_controller/delete_new_property/<?php echo $v_info['property_id']; ?>">Delete</a> |
                                                      <a href="<?php echo BASE_URL; ?>admin_controller/history_info_for_property/<?php echo $v_info['property_id']; ?>">History</a>
                                                       </td>
                                                   </tr>
