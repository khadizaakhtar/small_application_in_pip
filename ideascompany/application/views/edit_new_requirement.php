                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="main-content">
                            ...
                            <form action="<?php echo BASE_URL; ?>/admin_controller/update_new_requirement_info" method="post">
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div id="tags">
                                        <input type="hidden" id="townvalue" name="townvalue" value="<?php if(isset($new) && !empty($new)){ echo $new; }?>" class="form-control" placeholder=""/>
                                      <input type="text" name="town" id="town" class="text-center" placeholder="Add" />
                                        <button type="button" id="addTag">ADD</button>
				       <?php
                                       if(!empty($town)){
                                       foreach($town as $k=>$v_town){?>
					...
					<?php } }?>
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="select">
                                        <select name="rccheck" class="selectpicker" data-style="btn-select">
                                            <option value="no"<?php if (($v_info['rccheck'])=='no') echo 'selected'; ?>>No</option>
                                            <option value="yes"<?php if (($v_info['rccheck'])=='yes') echo 'selected'; ?>>Yes</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group full-width">
                                    ...
                                    <div class="border-box">
                                        <input type="text" name="floor_area_from" value="<?php echo $v_info['floor_area_from']; ?>" class="form-control floor_area_from"/>
                                        <span>to</span>
                                        <input type="text" name="floor_area_to" value="<?php echo $v_info['floor_area_to']; ?>" class="form-control floor_area_to"/>
                                    </div><br style="clear:both" />
                                </div>
                                 ...
                                 <div class="form-group full-width">
                                    ...
                                    <div class="select">
                                        <select  name='use_class' class="selectpicker" data-style="btn-select">          
                                            ...
                                            <option value="A1/A3" <?php if (($v_info['use_class'])=='A1/A3') echo 'selected'; ?>>A1/A3</option>
                                            ...
                                            <option value="A4" <?php if (($v_info['use_class'])=='A4') echo 'selected'; ?>>A4</option>
                                            <option value="A5" <?php if (($v_info['use_class'])=='A5') echo 'selected'; ?>>A5</option>
                                            <option value="B1" <?php if (($v_info['use_class'])=='B1') echo 'selected'; ?>>B1</option>
                                            <option value="B2" <?php if (($v_info['use_class'])=='B2') echo 'selected'; ?>>B2</option>
                                            <option value="B8" <?php if (($v_info['use_class'])=='B8') echo 'selected'; ?>>B8</option>
                                            <option value="C1" <?php if (($v_info['use_class'])=='C1') echo 'selected'; ?>>C1</option>
                                            <option value="C2" <?php if (($v_info['use_class'])=='C2') echo 'selected'; ?>>C2</option>
                                            <option value="C3" <?php if (($v_info['use_class'])=='C3') echo 'selected'; ?>>C3</option>
                                            <option value="C4" <?php if (($v_info['use_class'])=='C4') echo 'selected'; ?>>C4</option>
                                            <option value="D1" <?php if (($v_info['use_class'])=='D1') echo 'selected'; ?>>D1</option>
                                            <option value="D2" <?php if (($v_info['use_class'])=='D2') echo 'selected'; ?>>D2</option>
                                            <option value="Sui Generis" <?php if (($v_info['use_class'])=='Sui Generis') echo 'selected'; ?>>Sui Generis</option>
                                        </select>
                                    </div>
                                </div> 
