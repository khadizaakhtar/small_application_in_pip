            ...
            <div class="col-sm-12">
                <div class="main-content">
                   ...
                   <form action="<?php echo BASE_URL; ?>admin_controller/property_pdf_page/" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group full-width">
                            <label for="floorArea" class="label-1">Sales area<span style="color:red">*</span></label>
                       ...
                       <div class="form-group full-width">
                        ...
                        <div class="form-group full-width">
                            ...
                            <div class="divRight">
                            <input type="file" id="myFileInput" value="<?php if(isset($_POST['image'])) echo $_POST['image']; ?>" name='image' />
