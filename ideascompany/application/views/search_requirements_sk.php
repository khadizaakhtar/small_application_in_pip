                                        ...
                                        if (isset($result) && !empty($result)) {
                                            ...
                                            foreach ($result as $key => $req) { 
                                                ...
                                                <li>
                                                    ...
                                                    <div>
                                                        <input  type="checkbox" class="rs_tottgle_select rreq new_selected_<?php echo $result[$key]['0']['requirement_id']; ?>" name="data[requirement_id][]" value="<?php echo $result[$key]['0']['requirement_id']; ?>"></div>
                                     ...
                                     <input type="checkbox"  name="data[agent_id][<?php echo $result[$key]['0']['requirement_id']; ?>][]" value="<?php echo $require['agent_id']; ?>"/>
                                          ...
                                          <span class="telephone-no"> Tel: <?php echo $require['agent_phone_number']; ?> - </span>
                                                                ...
                                                                <div class="right-align rs_right">
                                                                    ...
                                                                    <button type="button" class="rs_tottgle_select new_select rm_select" check_attr ="0" data-attr="<?php echo $result[$key]['0']['requirement_id']; ?>" name="data[agent_id][<?php echo $result[$key]['0']['requirement_id']; ?>][]" value="<?php echo $require['agent_id']; ?>">SELECT</button>
         ...
         <script>
            $(document).ready(function() {
                $('.rs_tottgle_select').click(function(e) {
                    ...
                    var check = $(this).attr('check_attr'); alert(check);
                     ...
                     var rreq=$('.rreq').val();
                      ...
                      if((rreq == req)  && (check == 0)){
                        ...
                        $('.rs_tottgle_select').attr('check_attr','1'); 
                       }
                       
                     else if((rreq == req)  && (check == 1)){
                           alert('hgxssd'); 
                           $(".new_selected_"+rreq).prop("checked", false);
                           $('.rs_tottgle_select').attr('check_attr','0'); 
                       }
