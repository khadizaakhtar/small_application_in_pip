        ...
        <div id="main" class="site-main">
            <div class="container">
                                    ...
                                    foreach ($result as $k => $v_result) {
                                        ...
                                        <li>
                                            ...
                                            <div class="property-details">
                                                <span><i class="fa fa-map-marker"></i><?php echo $v_result['town']; ?>, <?php echo $v_result['country']; ?></span><span><i class="address-mark"><?php echo $v_result['use_class'] ?></i> Ground Floor Sales Area: <?php echo $v_result['floor_area']; ?> sq ft | Ancillary: <?php echo $v_result['ancillary_area']; ?> sq ft</span>
                ...
                <!-- <input type="text" name="data[emailbody]" value='Hi...' class="form-control"/> -->
                                                                    ...
                                                                    <textarea cols="40" rows="5" name="data[emailbody]" class="form-control"><?php
                                                                       // if (isset($agent_info) && !empty($agent_info)) {
                                                                          //  foreach ($agent_info as $v_info) {
                                                                               // $str = $v_info['agent_name'] . "," . "";
                ...
                Please find the attached marketing details for a property we believe suits your requirements.
                ...
                Kind regards
                                                                        ...
                                                                        if (isset($staffid) && !empty($staffid)) {
                                                                            foreach ($staffid as $v_staff) {
                                                                                echo $v_staff['user_name'];
                                                                            }
                                                                        }
                                                                        ?>
                                                                    </textarea>
